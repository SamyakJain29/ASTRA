...
export function StatusBar({
  ...
  return (
    <footer className="h-7 w-full bg-[#020706]/85 backdrop-blur-sm px-4 flex items-center justify-between text-[10px] z-50 shrink-0 select-none text-[#71817B] border-t border-[#668F87]/15">
      <div className="flex items-center gap-3">
        ...
        <span>
          ...
          <span className="text-[#F6D365] font-mono font-medium">
            {catalogCount !== undefined ? `${catalogCount} OBJECTS (LIVE)` : "-- OBJECTS"}
          </span>
        </span>
      </div>
